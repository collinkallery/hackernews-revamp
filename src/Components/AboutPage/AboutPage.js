...
// Was thinking we could add to this About based on our MVP that if people want to post article or comments to visit the original site
// We can explain the purpose of our product providing a mobile UI and letting users save favorite articles -LL
...
const AboutPage = () => {
  return (
    ...
    <p>
    Hacker News is a bit different from other community sites, and we'd appreciate it if you'd take a minute to read the following as well as the 
    <a href="https://news.ycombinator.com/newsguidelines.html">official guidelines</a>.
    </p>
